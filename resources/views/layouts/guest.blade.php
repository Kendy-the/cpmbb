...
<html lang="fr">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <header class="text-white">
            {{-- dynamic header --}}
            <nav class="bg-primary-500 border-gray-200">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                    <a href="https://flowbite.com" class="flex items-center space-x-3 rtl:space-x-reverse">
                        {{-- <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo" /> --}}
                        <span class="self-center text-2xl font-semibold whitespace-nowrap uppercase">cpmb</span>
                    </a>
                    <div class="flex items-center space-x-6 rtl:space-x-reverse">
                        ...
                        @class([
                            'text-sm hover:underline',
                            'underline' => str_contains(
                            request()->route() != null ? request()->route()->getName() : ' ','login')
                        ])>Se connecter</a>
                    </div>
                </div>
            </nav>
            ...
            :class="isSticky ? 'fixed animate-slideDown top-0 w-full inset-x-0 bg-primary-500':'relative bg-primary'"
            >
                        ...
                        <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                            <li>
                                ...
                                @class([
                                    'text-sm hover:underline',
                                    'underline' => str_contains(
                                    request()->route() != null ? request()->route()->getName() : ' ','home')
                                ])>Accueil</a>
                            </li>
                            <li>
                                ...
                                @class([
                                    'text-sm hover:underline',
                                    'underline' => str_contains(
                                    request()->route() != null ? request()->route()->getName() : ' ','programs')
                                ])>Programmes</a>
                            </li>
                            <li>
                                <a href="{{ route('about') }}" 
                                @class([
                                    'text-sm hover:underline',
                                    'underline' => str_contains(
                                    request()->route() != null ? request()->route()->getName() : ' ','about')
                                ])>A propos</a>
                            </li>
                            <li>
                                ...
                                @class([
                                    'text-sm hover:underline',
                                    'underline' => str_contains(
                                    request()->route() != null ? request()->route()->getName() : ' ','contact')
                                ])>Contact</a>
                            </li>
                        </ul>
                    </div>
        ...
        <footer class="bg-primary text-white">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" class="flex items-center">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap">Cpmb</span>
                    </a>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    ...
                    <a href="#" class="text-gray-50 hover:text-gray-900  ms-5">
